...
/**
 * An {@link SentenceProcessor} that modifies an
 * {@link textractor.chain.ArticleSentencesPair} based on some criteria.
 */
public interface SentenceTransformer extends SentenceProcessor {
    /**
     ...
     */
    ArticleSentencesPair transform(final ArticleSentencesPair pair)
