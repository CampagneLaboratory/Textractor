...
public final class UnofficialPorterStemmer {
    ...
    protected String step1a(final String str) {
        // SSES -> SS
    ...
    protected String step1b(final String str) {
        // (m > 0) EED -> EE
        if (str.endsWith("eed")) {
    ...
    protected String step1b2(final String str) {
        // AT -> ATE
        if (str.endsWith("at") ||
            str.endsWith("bl") ||
            str.endsWith("iz")) {
    ...
    protected String step1c(final String str) {
        // (*v*) Y -> I
        if (str.endsWith("y")) {
    ...
    protected String step2(final String str) {
        // (m > 0) ATIONAL -> ATE
    ...
    protected String step3 (final String str) {
        // (m > 0) ICATE -> IC
    ...
    protected String step4 (final String str) {
        if ((str.endsWith("al")) &&
    ...
    protected String step5a(final String str) {
	// (m > 1) E ->
    ...
    protected String step5b (final String str) {
        // (m > 1 and *d and *L) ->
        if (str.endsWith("l") &&
    ...
    */
     ...
     */
    protected boolean endsWithS(final String str) {
     ...
     */
    protected boolean containsVowel(final String str) {
    ...
    protected boolean endsWithDoubleConsonent(final String str) {
    ...
    protected int stringMeasure(final String str) {
        int count = 0;
    ...
    protected boolean endsWithCVC(final String str) {
        char c, v, c2 = ' ';
        if (str.length() >= 3) {
