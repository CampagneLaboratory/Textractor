 ...
 *
 */
public final class SentenceReferenceFilter implements SentenceFilter, Serializable {
    /**
    ...
    public boolean filterSentence(final TextractorDocument document) {
        return document.getDocumentSection() == TextractorDocument.REFERENCE_SECTION;
    }
}
