...
/**
 * Generated class implementing code defined by a snowball script. Implements the Porter stemming algorithm.   See http://snowball.tartarus.org/index.php
 */
public class SnowballPorterStemmer extends SnowballProgram {
    ...
    private void copy_from(SnowballPorterStemmer other) {
