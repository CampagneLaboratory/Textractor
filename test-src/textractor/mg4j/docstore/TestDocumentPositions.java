...
public class TestDocumentPositions extends TestCase {
    /**
     * Article under test.
     */
    ...
    private final PositionedTerm[][] expectedPositionedTerms = {{
            ...
            // It
            new PositionedTerm(2, new IntRange(0x55, 0x56), "It"),
            // was
            new PositionedTerm(32, new IntRange(0x58, 0x5A), "was"),
            // 20
            new PositionedTerm(1, new IntRange(0x5F, 0x60), "20"),
            // years
            new PositionedTerm(33, new IntRange(0x62, 0x66), "years"),
            // ago
            new PositionedTerm(4, new IntRange(0x68, 0x6A), "ago"),
            // today
            new PositionedTerm(29, new IntRange(0x6C, 0x70), "today"),
            // That
            new PositionedTerm(26, new IntRange(0x85, 0x88), "That"),
            // Sgt.
            new PositionedTerm(23, new IntRange(0x8D, 0x90), "Sgt.")
    }, {
            // Pepper
            new PositionedTerm(18, new IntRange(0x92, 0x97), "Pepper"),
            // told
            new PositionedTerm(30, new IntRange(0x99, 0x9C), "told"),
            // his
            new PositionedTerm(12, new IntRange(0xA2, 0xA4), "his"),
            // band
            new PositionedTerm(6, new IntRange(0xA6, 0xA9), "band"),
            // to
            new PositionedTerm(28, new IntRange(0xAB, 0xAC), "to"),
            // play
            new PositionedTerm(19, new IntRange(0xAE, 0xB1), "play"),
            // They
            new PositionedTerm(27, new IntRange(0xC2, 0xC5), "They"),
            // ve
            new PositionedTerm(31, new IntRange(0xC7, 0xC8), "ve"),
            // been
            new PositionedTerm(7, new IntRange(0xCA, 0xCD), "been"),
            // going
            new PositionedTerm(10, new IntRange(0xCF, 0xD3), "going"),
            // in
            new PositionedTerm(13, new IntRange(0xD5, 0xD6), "in"),
            // and
            new PositionedTerm(5, new IntRange(0xD8, 0xDA), "and"),
            // out
            new PositionedTerm(16, new IntRange(0xDC, 0xDE), "out"),
            // of
            new PositionedTerm(15, new IntRange(0xE0, 0xE1), "of"),
            // style
            new PositionedTerm(25, new IntRange(0xE3, 0xE7), "style"),
            // But
            new PositionedTerm(8, new IntRange(0xF8, 0xFA), "But"),
            // they
            new PositionedTerm(27, new IntRange(0xFC, 0xFF), "they"),
            // re
            new PositionedTerm(21, new IntRange(0x101, 0x102), "re"),
            // guaranteed
            new PositionedTerm(11, new IntRange(0x104, 0x10D), "guaranteed"),
            // to
            new PositionedTerm(28, new IntRange(0x10F, 0x110), "to"),
            // raise
            new PositionedTerm(20, new IntRange(0x112, 0x116), "raise"),
            // a
            new PositionedTerm(3, new IntRange(0x118), "a"),
            // smile
            new PositionedTerm(24, new IntRange(0x11A, 0x11E), "smile")
    }};

    public TestDocumentPositions() throws Exception {
        super();
        ...
        indexer.setBasename("index/position-test");
    ...
    public void testExtractTermsWithPositions() throws NoSuchMethodException,
        ...
        final DocumentIndexManager manager =
                new DocumentIndexManager("index/position-test");
        int i = 0;
    ...
    public void testDocumentStorePositions() throws NoSuchMethodException,
        ...
        final DocumentStoreReader reader =
                new DocumentStoreReader(new DocumentIndexManager("index/position-test"));
        for (int i = 0; i <= 1; i++) {
    ...
    private class TestFilter extends AbstractSentenceTransformer {
         ...
         */
        public ArticleSentencesPair transform(final ArticleSentencesPair pair) throws SentenceProcessingException {
